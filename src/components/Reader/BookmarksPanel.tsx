...
export const BookmarksPanel: React.FC<BookmarksPanelProps> = ({
  ...
  const formatDate = (date: Date) => {
    ...
    if (diffInHours < 168) return `${Math.round(diffInHours / 24)}d ago`;
      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg font-semibold" style={{ color: interfaceStyles.color }}>Bookmarks</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex-1">
          {bookmarks.length === 0 ? (
            <div className="p-8 text-center" style={{ color: interfaceStyles.color }}>
              ...
              <p className="text-sm opacity-60">Add bookmarks to save your favorite passages and important locations</p>
            </div>
          ) : (
